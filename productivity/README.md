...
This is just the beginning. I hope to:
- Improve the UI/UX
- Add daily reminders and notifications
- Integrate cloud storage (maybe Firebase)
- Build more great apps in the future!

---

## 📄 License

Licensed under the [MIT License](LICENSE). Feel free to fork, use, and modify with credit.
